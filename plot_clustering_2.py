...
if __name__ == '__main__':
    ...
    for n_clusters in n_clusters_list:
        ...
        awera.cluster_frequency_maps(use_rel='cluster', read_input=True)
        awera.cluster_frequency_maps(use_rel='loc', read_input=True)
        # # ----------------------------------------
        ...
        # wind_data = awera.analyse_pc(data=data)
